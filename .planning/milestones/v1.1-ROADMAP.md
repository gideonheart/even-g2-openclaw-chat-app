...
- [x] **Phase 7: Error Handling & Lifecycle** - Resilient voice loop with error recovery and graceful shutdown
...
Plans:
- [x] 07-01-PLAN.md -- Error recovery flow: FSM reset input, gateway timeout with AbortSignal.timeout(30s), user-visible error messages
- [x] 07-02-PLAN.md -- Graceful shutdown: lifecycle cleanup on visibilitychange/pagehide, module destroy in reverse order
